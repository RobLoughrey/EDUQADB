...
<body>
    <form id="form1" runat="server">
        ...
        <div id="side-panel">
                ...
                <br />
                    <asp:Button ID="btnSearchTrainings" runat="server" Text="Search Trainings" OnClick="btnSearchTrainings_Click" />
                <h2><asp:Label ID="lblAdminButtons" runat="server" Text="Admin"></asp:Label></h2>
                <br />
                <asp:Button ID="btnGetUsers" runat="server" Text="User List" OnClick="btnGetUsers_Click" CssClass="main-button" />
                <asp:Button ID="btnEditUser" runat="server" Text="Edit User" OnClick="btnEditUser_Click" CssClass="main-button" />
                <asp:Button ID="btnAddUser" runat="server" Text="Add User" OnClick="btnAddUser_Click" CssClass="main-button" />
                <br />
        </div>
        <div id="main-content">
